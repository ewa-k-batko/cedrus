...
--
-- Host: 127.0.0.1
-- Generation Time: 13 Mar 2016, 00:18
...
set @querySt =  'SELECT  cpp_id,cpp_no_isn,cpp_cpc_id, cpp_gal_id, cpp_pot_id, cpp_name_pl, cpp_name_lt, cpp_desc, cpp_height, cpp_icon, cpp_status, cpp_price, cpp_create, cpp_mod, cpp_user_create, cpp_user_mod
                FROM 
...
CREATE  PROCEDURE `PL_STUFF_LIST_ALL`(
...
CREATE   PROCEDURE `TESTRY`(IN  p_id  INT(10))
BEGIN
...
CREATE   PROCEDURE `TESTY`(IN  p_id  INT(10))
BEGIN
    END$$
...
--
-- Struktura tabeli dla tabeli `cdr_gallery_bind`
--

DROP TABLE IF EXISTS `cdr_gallery_bind`;
CREATE TABLE IF NOT EXISTS `cdr_gallery_bind` (
...
--
-- Struktura tabeli dla tabeli `cdr_photo`
--

DROP TABLE IF EXISTS `cdr_photo`;
CREATE TABLE IF NOT EXISTS `cdr_photo` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci PACK_KEYS=0 AUTO_INCREMENT=22 ;
...
CREATE TABLE IF NOT EXISTS `cdr_plant_plant` (
  ...
  `cpp_price` varchar(7) COLLATE utf8_polish_ci DEFAULT NULL,
...
--
-- Struktura tabeli dla tabeli `cdr_plant_pot`
--

DROP TABLE IF EXISTS `cdr_plant_pot`;
CREATE TABLE IF NOT EXISTS `cdr_plant_pot` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci PACK_KEYS=0 AUTO_INCREMENT=18 ;

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `cdr_stuff`
--

DROP TABLE IF EXISTS `cdr_stuff`;
CREATE TABLE IF NOT EXISTS `cdr_stuff` (
...
--
-- Ograniczenia dla tabeli `cdr_gallery_bind`
--
ALTER TABLE `cdr_gallery_bind`
  ADD CONSTRAINT `cdr_gallery_bind_fk1` FOREIGN KEY (`cbi_csf_id`) REFERENCES `cdr_stuff` (`csf_id`),
  ADD CONSTRAINT `cdr_gallery_bind_fk2` FOREIGN KEY (`cbi_cph_id`) REFERENCES `cdr_photo` (`cph_id`);
